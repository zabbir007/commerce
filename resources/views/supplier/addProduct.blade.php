                    ...
                    <div class="col-md-8 col-lg-8 col-xl-8">
                        <div class="card bg-pattern">
                            ...
                            <div class="card-body p-4">
                                ...
                                <form action="{{route('saveProduct')}}"  class="parsley-examples" enctype="multipart/form-data" method="post" novalidate>
                                    ...
                                    <div style="margin-top: 40px;" class="alert alert-danger alert-dismissible bg-danger text-white border-0 fade show" role="alert">
                                     ...
                                     @endif
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="text" name="productName" class="form-control parsley-validated" required
                                        ...
                                        <div class="form-group" >
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div>
                                                <textarea name="productDescription" required data-parsley-required-message="Please Enter Product Description" class="form-control"></textarea>
                                            </div>
                                        </div>

                                         <div class="form-group mb-0 text-center">
                                            <button class="btn btn-success btn-block" id="" type="submit">Save</button>
                                        </div>
                                </form>
                            </div> <!-- end card-body -->
                        </div>
