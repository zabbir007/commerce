                            ...
                            @foreach($productInfo as $product)   
                                <tr>
                                    ...
                                    <td>
                                     ...
                                     <a type="button" class="btn btn-warning btn-rounded waves-effect waves-light "  href="{{route('editProduct',[$product->id,$productInfo->currentPage()])}}" >Edit</a>
                                     <a type="button" href="#" id="{{$product->id}}" class="btn btn-danger btnProductDelete btn-rounded waves-effect waves-light">Delete</a>
                                    </td>
